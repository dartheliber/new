--consultas utiles dba Oracle
--How do I determine if a table has a primary key and if it has one, 
--how do I determine what columns are in the primary key?
...
--If you knew the table name that you were looking for, 
--you could modify the SQL as follows:
SELECT cols.table_name, cols.column_name, cols.position, cons.status, cons.owner
FROM all_constraints cons, all_cons_columns cols
